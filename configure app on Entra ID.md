...
## Grant Permissions: Go to your Data Factory resource in the Azure Portal > Access control (IAM) > Add role assignment. Assign the Data Factory Contributor role to the App Registration you just created. 
